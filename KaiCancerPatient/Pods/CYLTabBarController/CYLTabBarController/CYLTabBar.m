...
- (UITraitCollection *)traitCollection {
    NSMutableArray* newTraitCollection = [NSMutableArray arrayWithObject:[super traitCollection]];
    if(UIDevice.currentDevice.userInterfaceIdiom == UIUserInterfaceIdiomPad){
        [newTraitCollection addObject:[UITraitCollection traitCollectionWithVerticalSizeClass:UIUserInterfaceSizeClassRegular]];
        [newTraitCollection addObject:[UITraitCollection traitCollectionWithVerticalSizeClass:UIUserInterfaceSizeClassCompact]];
    }
    return [UITraitCollection traitCollectionWithTraitsFromCollections:[NSArray arrayWithArray:newTraitCollection]];
}
