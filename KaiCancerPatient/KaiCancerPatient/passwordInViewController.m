...
//    }
    ...
    [manager POST:@"http://sfp.dev.hins.work/api/login" parameters:dict headers:headers progress:^(NSProgress * _Nonnull uploadProgress) {
      ...
      [[NSUserDefaults standardUserDefaults]setObject:responseDictionary[@"data"][@"encodedAccessToken"] forKey:@"ACCESS_KEY"];
      [[NSUserDefaults standardUserDefaults]setObject:responseDictionary forKey:@"USER_DATA"];
